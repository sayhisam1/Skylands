...
local BackpackMenuButton = Roact.PureComponent:extend("BackpackMenuButton")

function BackpackMenuButton:render()
    ...
    if self.props.BackgroundIconProps then
        self.props.BackgroundIconProps.BackgroundTransparency = self.props.BackgroundIconProps.BackgroundTransparency or 1
        ...
        self.props.BackgroundIconProps.AnchorPoint = self.props.BackgroundIconProps.AnchorPoint or self.props.AnchorPoint or Vector2.new(.5, .5)
    end
    ...
    self.props.TextProps.ShadowTextStrokeColor3 = self.props.TextProps.ShadowTextStrokeColor3 or Color3.fromRGB(255, 255, 255)
    ...
    return Roact.createElement(
        ...
        },
        {
            ...
            BackgroundIcon = self.props.BackgroundIconProps and Roact.createElement("ImageLabel", self.props.BackgroundIconProps),
